            ...
            <form className='relative z-10 glassy p-5 bg-blue-300 mt-10 flex flex-col gap-5 font-bold text-white'>
                ...
                <button
                    onClick={e => {
                        ...
                        window.location.href = window.location.origin + window.location.pathname + '?room=' + inputRef.current.value.trim().replace(' ', '-')
                    }}
                ...
                <button
                    onClick={(e) => {
                        e.preventDefault();
                        console.log(window.location.origin + window.location.path + '?room=' + uuidv4())

                        window.location.href = window.location.origin + window.location.pathname + '?room=' + uuidv4();
